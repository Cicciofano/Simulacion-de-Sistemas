...
#png("p10t50.png")
#plot(tiempos1[,1], type="l", col=2, ylim=c(1.5,2.5), xlab="Réplicas",ylab="Minutos")
#lines(tiempos2[,1],type="l", col=3, ylim=c(2,4))
#legend("topleft", legend=c("Secuencial", "Paralelo"),
